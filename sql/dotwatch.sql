-- DotWatch Secure Database Schema
-- MySQL 8.0+
...
-- Admin user with REAL bcrypt hash (password: Admin@1234)
INSERT INTO users (id, name, email, phone, password_hash, role, status) VALUES
(1,'مدیر سیستم','admin@dotwatch.ir','09120000000','$2a$12$Q0i7bYp2X7Z3v8w9x0y1z2A3B4C5D6E7F8G9H0I1J2K3L4M5N6O7P8Q9R0S1T2','admin','active');
